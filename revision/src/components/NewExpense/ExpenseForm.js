...
export default function ExpenseForm(props) {
  ...
  const titleChangeHandler = (e) => {
    // event.target.value -> you can console.log(event) and find in dev tools
  ...
  const submitHandler = (event) => {
    ...
    // Passing data from ExpenseForm to NewExpense thorough props (Child to parent, bottom-up)
